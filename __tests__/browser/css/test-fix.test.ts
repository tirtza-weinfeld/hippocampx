...
describe('Test fix: flatten --ink-base', () => {
  beforeEach(() => {
    document.querySelectorAll('style').forEach(s => s.remove())
  })

  it('TEST K: Flatten --ink-base (--l-ink first, then --neutral)', () => {
    ...
    style.textContent = `
      ...
      @layer tokens {
        ...
        :root {
          ...
          --l-layer-loud-light: 0.9;
          --l-layer-quiet-dark: 0.1;
        ...
        :root {
          /* FIX: Flatten --ink-base by computing --l-ink first */
          --l-ink: --pick(var(--l-ink-light), var(--l-ink-dark));
          --ink-base: --neutral(var(--l-ink));
    ...
    console.log('TEST K (flattened --ink-base):')
    console.log('  --l-ink:', root.getPropertyValue('--l-ink').trim())
