...
describe('Test fix: separate :root blocks', () => {
  beforeEach(() => {
    document.querySelectorAll('style').forEach(s => s.remove())
  })

  it('TEST M: Put --ink-base in separate :root block', () => {
    ...
    console.log('TEST M (3 separate :root blocks):')
