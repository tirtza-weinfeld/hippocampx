...
describe('Narrow down bug - literal values in --layer-base branches', () => {
  beforeEach(() => {
    document.querySelectorAll('style').forEach(s => s.remove())
  })

  it('TEST 56: Literal values in non-active branches of --layer-base', () => {
    ...
    style.textContent = `
      ...
      @layer tokens {
        ...
        :root{
          ...
          /* Using literals instead of var refs for non-active branches */
        ...
        :root {
          ...
          /* Use LITERAL values for loud/quiet branches, var for mid */
          --layer-base: if(
    ...
    console.log('TEST 56 (literal values in non-active branches):')
  ...
  it('TEST 57: Same as 56 but WITH --l-layer-quiet/loud vars (defined, not used)', () => {
    const style = document.createElement('style')
    style.textContent = `
      @layer tokens, base, system;
      ...
      @layer tokens {
        ...
        :root {
          ...
          /* Define all three, but use LITERALS in --layer-base */
          ...
          /* Use LITERAL values in --layer-base branches */
          --layer-base: if(
            style(--emphasis: loud):  --neutral(0.90);
            else: if(style(--emphasis: quiet): --neutral(0.97); else: --neutral(var(--l-layer-mid));)
          );
    ...
    document.head.appendChild(style)
    const root = getComputedStyle(document.documentElement)
    console.log('TEST 57 (--l-layer-* defined but literals in --layer-base):')
    console.log('  --layer-base:', root.getPropertyValue('--layer-base').trim())
    console.log('  --intent-color:', root.getPropertyValue('--intent-color').trim())
    console.log('  --g-layer-a:', root.getPropertyValue('--g-layer-a').trim())
    expect(root.getPropertyValue('--intent-color').trim()).not.toBe('')
  ...
  it('TEST 58: Use var(--l-layer-*) in --layer-base but NO --g-layer-a', () => {
    const style = document.createElement('style')
    style.textContent = `
      @layer tokens;
    ...
    document.head.appendChild(style)
    const root = getComputedStyle(document.documentElement)
    console.log('TEST 58 (var refs in all branches, NO --g-layer-a):')
    console.log('  --layer-base:', root.getPropertyValue('--layer-base').trim())
    console.log('  --intent-color:', root.getPropertyValue('--intent-color').trim())
    console.log('  --i0:', root.getPropertyValue('--i0').trim())
    console.log('  --i1:', root.getPropertyValue('--i1').trim())
  ...
  it('TEST 59: var refs in all branches WITH --g-layer-a', () => {
    const style = document.createElement('style')
    style.textContent = `
      @layer tokens;
    ...
    document.head.appendChild(style)
    const root = getComputedStyle(document.documentElement)
    console.log('TEST 59 (var refs in all branches WITH --g-layer-a):')
    console.log('  --layer-base:', root.getPropertyValue('--layer-base').trim())
    console.log('  --intent-color:', root.getPropertyValue('--intent-color').trim())
    console.log('  --g-layer-a:', root.getPropertyValue('--g-layer-a').trim())
    expect(root.getPropertyValue('--intent-color').trim()).not.toBe('')
  ...
  it('TEST 60: var refs only for ACTIVE branch (mid), literals for others', () => {
    const style = document.createElement('style')
    style.textContent = `
      @layer tokens;
      ...
      @layer tokens {
        ...
        :root {
          ...
          /* ONLY mid uses var, loud/quiet use literals */
          --layer-base: if(
            style(--emphasis: loud):  --neutral(0.90);
            else: if(style(--emphasis: quiet): --neutral(0.97); else: --neutral(var(--l-layer-mid));)
          );
    ...
    document.head.appendChild(style)
    const root = getComputedStyle(document.documentElement)
    console.log('TEST 60 (only mid uses var, others literal, WITH --g-layer-a):')
    console.log('  --layer-base:', root.getPropertyValue('--layer-base').trim())
    console.log('  --intent-color:', root.getPropertyValue('--intent-color').trim())
    console.log('  --g-layer-a:', root.getPropertyValue('--g-layer-a').trim())
    expect(root.getPropertyValue('--intent-color').trim()).not.toBe('')
