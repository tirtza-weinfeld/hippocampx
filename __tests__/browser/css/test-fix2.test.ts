...
describe('Test fix: reorder variables', () => {
  beforeEach(() => {
    document.querySelectorAll('style').forEach(s => s.remove())
  })

  it('TEST L: Move --ink-base AFTER --intent-color', () => {
    ...
    style.textContent = `
      ...
      @layer tokens {
        ...
        :root {
          ...
          /* MOVE --ink-base and --border AFTER the intent chain */
    ...
    console.log('TEST L (--ink-base moved after):')
