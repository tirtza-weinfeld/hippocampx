...
describe('Narrow down bug - oklch with var() references', () => {
  beforeEach(() => {
    document.querySelectorAll('style').forEach(s => s.remove())
  })

  it('TEST 76: --intent-accent with LITERAL values (no var refs)', () => {
    ...
    console.log('TEST 76 (--intent-accent with literals):')
  ...
  it('TEST 77: All 4 --intent-* colors with LITERAL values', () => {
    const style = document.createElement('style')
    style.textContent = `
      @layer tokens, base, system;
      ...
      @layer tokens {
        ...
        :root{
          ...
          /* ALL LITERAL values, no var refs */
          --intent-accent:      oklch(0.60 0.14 265);
    ...
    document.head.appendChild(style)
    const root = getComputedStyle(document.documentElement)
    console.log('TEST 77 (all 4 --intent-* with literals):')
    console.log('  --intent-color:', root.getPropertyValue('--intent-color').trim())
    console.log('  --g-layer-a:', root.getPropertyValue('--g-layer-a').trim())
    expect(root.getPropertyValue('--intent-color').trim()).not.toBe('')
  })

  it('TEST 78: --intent-accent with var(--hue) ONLY (literal chroma)', () => {
    const style = document.createElement('style')
    style.textContent = `
      @layer tokens, base, system;
      ...
      @layer tokens {
        ...
        :root{
          ...
          /* Only var(--hue), literal chroma */
          --intent-accent: oklch(0.60 0.14 var(--hue));
    ...
    document.head.appendChild(style)
    const root = getComputedStyle(document.documentElement)
    console.log('TEST 78 (--intent-accent with var(--hue) only):')
    console.log('  --intent-color:', root.getPropertyValue('--intent-color').trim())
    console.log('  --g-layer-a:', root.getPropertyValue('--g-layer-a').trim())
    expect(root.getPropertyValue('--intent-color').trim()).not.toBe('')
  })

  it('TEST 79: --intent-accent with var(--chroma) ONLY (literal hue)', () => {
    const style = document.createElement('style')
    style.textContent = `
      @layer tokens, base, system;
      ...
      @layer tokens {
        ...
        :root{
          ...
          /* Only var(--chroma), literal hue */
          --intent-accent: oklch(0.60 var(--chroma) 265);
    ...
    document.head.appendChild(style)
    const root = getComputedStyle(document.documentElement)
    console.log('TEST 79 (--intent-accent with var(--chroma) only):')
    console.log('  --intent-color:', root.getPropertyValue('--intent-color').trim())
    console.log('  --g-layer-a:', root.getPropertyValue('--g-layer-a').trim())
    expect(root.getPropertyValue('--intent-color').trim()).not.toBe('')
  })

  it('TEST 80: --intent-accent with BOTH var(--chroma) and var(--hue)', () => {
    const style = document.createElement('style')
    style.textContent = `
      @layer tokens, base, system;
    ...
    document.head.appendChild(style)
    const root = getComputedStyle(document.documentElement)
    console.log('TEST 80 (--intent-accent with BOTH var refs):')
    console.log('  --intent-color:', root.getPropertyValue('--intent-color').trim())
    console.log('  --g-layer-a:', root.getPropertyValue('--g-layer-a').trim())
    expect(root.getPropertyValue('--intent-color').trim()).not.toBe('')
  })
