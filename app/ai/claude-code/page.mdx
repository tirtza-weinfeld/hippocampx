...
|-----------|----------|---------|-----------|
| [**Skills**](./skills) | `.claude/skills/*/SKILL.md` | Auto (context match) | No |
| [**Subagents**](./subagents) | `.claude/agents/*.md` | Explicit or auto | Yes (subprocess) |
| [**Hooks**](./hooks) | `settings.json` | Lifecycle events | Yes (shell) |
| [**MCP**](./mcp) | `.mcp.json` | Tool calls | Yes (server) |

→ **[See all four working together](./example)** (React 19 workflow)
