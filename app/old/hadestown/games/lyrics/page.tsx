...
import { LyricChallengeGame } from "@/components/old/hadestown/games"
import { HADESTOWN_LYRICS, HADESTOWN_LYRICS_GAME_GUIDE } from "@/lib/data/vocabulary"
...
export default function LyricChallengePage() {
  ...
  return (
    <main className="hadestown @container min-h-screen py-8 bg-linear-to-b from-amber-50/30 to-amber-100/20 dark:from-gray-900 dark:to-amber-950/30 text-foreground">
      {/* Background */}
      <div className="fixed inset-0 pointer-events-none -z-10">
        <div className="absolute inset-0 bg-linear-to-br from-amber-500/5 via-transparent to-amber-500/5 dark:from-amber-500/10 dark:to-amber-500/10" />
        <div className="absolute bottom-0 w-full h-1/3 bg-linear-to-t from-amber-100/10 to-transparent dark:from-amber-700/10" />
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="text-center mb-8">
          ...
          >
            <div className="absolute inset-0 bg-linear-to-r from-old-game-primary/20 via-old-game-primary-dark/20 to-old-game-primary/20 rounded-lg blur-md" />
            ...
            <div className="relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-lg px-8 py-4 shadow-lg">
              <div className="flex items-center justify-center gap-3">
                <motion.div
                  ...
                  >
                    <MusicIcon className="h-8 w-8 text-old-game-primary" />
                </motion.div>
            ...
            >
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold text-old-game-primary">
                  How to Play: {HADESTOWN_LYRICS_GAME_GUIDE.title}
                </h2>
                <button
                  onClick={() => setShowGuide(false)}
              ...
              <div className="space-y-4 mb-6">
                {HADESTOWN_LYRICS_GAME_GUIDE.steps.map((step, index) => (
                  <motion.div
                    key={index}
                  ...
                  >
                    <div className="flex-shrink-0 w-6 h-6 rounded-full bg-old-game-primary-soft text-old-game-primary flex items-center justify-center font-bold text-sm">
                      {index + 1}
                    </div>
          ...
          >
            ...
            >
              ...
              <p className="text-old-game-text mb-6">
                You know your Hadestown lyrics! You could join the chorus!
              </p>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
