...
import { BookIcon, HelpCircleIcon, XIcon } from "lucide-react"
import { Card, CardContent } from "@/components/ui/card"
import { FillBlanksGame } from "@/components/old/hadestown/games"
    ...
    <main className="hadestown @container min-h-screen py-8 bg-gradient-to-b from-amber-50/30 to-amber-100/20 dark:from-gray-900 dark:to-amber-950/30 text-foreground">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="text-center mb-8">
          ...
          >
            Complete the sentences with the correct Hadestown vocabulary!
          </motion.p>
        </div>
            ...
            >
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold text-old-game-primary">
                  How to Play: {HADESTOWN_GAME_GUIDES.fillBlanks.title}
                </h2>
                <button
                  onClick={() => setShowGuide(false)}
              ...
              <div className="space-y-4 mb-6">
                {HADESTOWN_GAME_GUIDES.fillBlanks.steps.map((step, index) => (
                  <motion.div
                    key={index}
        ...
        {showCelebration && (
          ...
          >
            ...
            >
              ...
              <p className="text-old-game-text mb-6">{HADESTOWN_THEME.celebrationMessage}</p>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
