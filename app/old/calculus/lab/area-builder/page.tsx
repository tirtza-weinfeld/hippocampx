...
import { downloadCanvasAsImage } from "@/components/old/calculus/utility/share-utils"
import { shareCanvas } from "@/components/old/calculus/utility/share-utils"
          ...
          <Card className="border-2 border-border bg-background/60 backdrop-blur-sm">
            ...
            <CardContent className="p-6 space-y-6">
              ...
              <div className="flex justify-center mt-4">
                <Link href="/old/calculus/games/area-builder">
