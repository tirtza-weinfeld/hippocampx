...
$$
\dfrac{\color{red}{A}}{\color{blue}{B}} = \color{green}{Q} \ (\color{orange}{R})
$$

$\color{red}{A}$ is the dividend  
$\color{blue}{B}$ is the divisor  
$\color{green}{Q}$ is the quotient  
$\color{orange}{R}$ is the remainder

Sometimes, we are only interested in what the **remainder** is when we divide $A$ by $B$.
For these cases there is an operator called the *modulo operator* (abbreviated as *mod*).
Using the same $\color{red}{A}$, $\color{blue}{B}$, $\color{green}{Q}$, and $\color{orange}{R}$ as above, we would have: 

$$ 
\color{red}{A}\color{gray}{\pmod{\color{blue}{B}}} = \color{orange}{R} 
$$
