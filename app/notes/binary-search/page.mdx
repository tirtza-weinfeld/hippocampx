...
```python file=problems/35-search-insert-position/solution.py
```
...
```python file=problems/34-find-first-and-last-position-of-element-in-sorted-array/solution.py
```
  >[!tip] 
...
```python file=problems/153-find-minimum-in-rotated-sorted-array/solution.py
```
...
```python file=problems/875-koko-eating-bananas/solution.py
```
...
```python file=problems/1011-capacity-to-ship-packages-within-d-days/solution.py
```
