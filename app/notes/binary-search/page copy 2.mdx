...
```python file=problems/binary_search.py:simple_bisect_left 
```
...
```python file=problems/binary_search.py:simple_bisect_right
```
...
```python file=problems/35-search-insert-position/solution.py:search_insert_position
```
...
```python file=problems/34-find-first-and-last-position-of-element-in-sorted-array/solution.py:find_first_and_last_position_of_element_in_sorted_array
```
  >[!tip] 
...
```python file=problems/153-find-minimum-in-rotated-sorted-array/solution.py:find_minimum_in_rotated_sorted_array
```
...
```python file=problems/875-koko-eating-bananas/solution.py:koko_eating_bananas
```
...
```python file=problems/1011-capacity-to-ship-packages-within-d-days/solution.py:capacity_to_ship_packages_within_d_days
```
