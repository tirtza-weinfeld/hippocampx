...
```python file=core/binary-search/bisect_left.py
```
...
```python file=core/binary-search/bisect_right.py
```
...
```python file=problems/35-search-insert-position/solution.py:searchInsert
```
...
```python file=problems/34-find-first-and-last-position-of-element-in-sorted-array/solution.py:searchRange
```
  >[!tip] 
...
```python file=problems/153-find-minimum-in-rotated-sorted-array/solution.py:findMin
```
...
```python file=problems/875-koko-eating-bananas/solution.py:minEatingSpeed
```
...
```python file=problems/1011-capacity-to-ship-packages-within-d-days/solution.py:shipWithinDays
```
