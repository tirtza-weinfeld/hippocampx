...
```python file=examples/code/prefix_sum.py#func:subarraySum 
```
...
```python file=examples/code/prefix_sum.py#func:findMaxLength 
```
...
```python file=examples/code/prefix_sum.py#func:checkSubarraySum 
```
...
```python file=examples/code/prefix_sum.py#func:subarraysDivByK 
```
...
```python file=examples/code/prefix_sum.py#func:minSubarray 
```
...
```python file=examples/code/prefix_sum.py#func:getModifiedArray 
```
...
```python file=examples/code/prefix_sum.py#func:numberOfArrays 
```
