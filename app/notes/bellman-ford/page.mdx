...
>   - ~ if any edge is relaxable (i.e., violates the triangle inequality) → *negative-weight cycle exists*.
>   - ~ otherwise, *d(s, v) = δ(s, v) for all v ∈ V*



```python file=core/bellman-ford/classic.py 
```
...
```python file=core/bellman-ford/layered_dag.py
```
...
> 
> 
> - ~ **Initialize δ₀ (distance 0 at `source`, ∞ elsewhere)**
> 
>    ```python
...
> 
> - ~ **Layered relaxation: compute δ₁…δ_V**
> 
>    ```python
...
> 
> - ~ **Detect direct witnesses ($δ_V < δ_{V-1}$)**
> 
>    ```python
>    witnesses = {
>        v
...
> 
> - ~ **Build successor list for propagation**
> 
>    ```python
...
```python file=problems/787-cheapest-flights-within-k-stops/bellman_ford.py:cheapest_flights_with_at_most_k_stops 
```
...
> 
> - ~ **Mapping to the variant 2's layered-DAG Bellman-Ford**
> 
...
> 
> - ~ **Classic (in-place) Bellman-Ford vs. layered version**
> 
>    
>    - ~ *Classic BF*
...
```python file=problems/1514-path-with-maximum-probability/solution.py:path_with_maximum_probability  
```
