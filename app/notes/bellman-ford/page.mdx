...
```python file=examples/code/bellman-ford.py#func:bellman_ford_classic  
```
...
```python file=examples/code/bellman-ford.py#func:bellman_ford_layered_dag  
```
...
```python file=examples/code/bellman-ford.py#func:findCheapestPrice  
```
...
```python file=examples/code/bellman-ford.py#func:maxProbability  
```
