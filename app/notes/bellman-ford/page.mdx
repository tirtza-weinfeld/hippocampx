...
>    * **Your DP** does the same in “software”: each `for _ in range(k+1)` pass reads δₖ from `d` and writes δₖ₊₁ into `tmp`.
...
> ---
> 
> **In summary:** your cheapest-flights DP *is* the layered-DAG Bellman-Ford in disguise. The `tmp` copy enforces strict layering (δₖ→δₖ₊₁), matching
