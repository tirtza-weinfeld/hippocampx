...
```python file=backend/algorithms/kadane.py#method:Kadane.maxSubArray
```
...
```python file=backend/algorithms/kadane.py#method:Kadane.maxProduct
```
...
```python file=backend/algorithms/kadane.py#method:Kadane.maxSubarraySumCircular
```
...
```python file=backend/algorithms/kadane.py#method:Kadane.maxPathSum
```
...
```python file=backend/algorithms/kadane.py#method:Kadane.maxSumSubmatrix
```
