...
|----------|----------------|--------------------------|
| [transformer.md](transformer.md) | Core architecture: attention, RoPE, GQA, MoE, KV cache | Understand how the model processes tokens |
| [generation.md](generation.md) | Autoregressive loop, temperature, top-p sampling | Understand how text is generated token-by-token |
| [tokenizer.md](tokenizer.md) | BPE encoding, special tokens, chat formatting | Understand text ↔ token ID conversion |
| [vision.md](vision.md) | ViT encoder, patch embedding, pixel shuffle | Understand image processing pipeline |
| [quantization.md](quantization.md) | INT4/FP8 compression, memory optimization | Deploy on limited GPU memory |
...
| doc | github |
|------------|-------|
| [Generation](ai/generation) | https://github.com/tirtza-weinfeld/hippocampx/tree/main/app/learn/ai/generation/page.mdx|
| [PyTorch](ai/pytorch) | https://github.com/tirtza-weinfeld/hippocampx/tree/main/app/learn/ai/pytorch/page.mdx|
| [Quantization](ai/quantization)| https://github.com/tirtza-weinfeld/hippocampx/tree/main/app/learn/ai/quantization/page.mdx|
| [Tokenizer](ai/tokenizer)| https://github.com/tirtza-weinfeld/hippocampx/tree/main/app/learn/ai/tokenizer/page.mdx|
| [Transformer](ai/transformer) | https://github.com/tirtza-weinfeld/hippocampx/tree/main/app/learn/ai/transformer/page.mdx|
| [Vision](ai/vision) | https://github.com/tirtza-weinfeld/hippocampx/tree/main/app/learn/ai/vision/page.mdx|
