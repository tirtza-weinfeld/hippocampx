...
|-----------|------|----------------------|
| Embedding | [model.py](../model.py) ,[](https://github.com/tirtza-weinfeld/broca/blob/main/model.py)| `Transformer.tok_embeddings` |
| Attention | [model.py](../model.py) ,[](https://github.com/tirtza-weinfeld/broca/blob/main/model.py)| `Attention.forward()` |
| KV Cache | [model.py](../model.py) , [](https://github.com/tirtza-weinfeld/broca/blob/main/model.py)| `Attention.cache_k`, `Attention.cache_v` |
| RoPE | [model.py](../model.py)  , [](https://github.com/tirtza-weinfeld/broca/blob/main/model.py)| `apply_rotary_emb()`, `precompute_freqs_cis()` |
| Scaled RoPE | [model.py](../model.py)  , [](https://github.com/tirtza-weinfeld/broca/blob/main/model.py)| `apply_scaling()` |
| Masking | [model.py](../model.py)  , [](https://github.com/tirtza-weinfeld/broca/blob/main/model.py)| `create_chunked_attention_mask()` |
| FFN | [ffn.py](../ffn.py)  , [](https://github.com/tirtza-weinfeld/broca/blob/main/ffn.py)| `FeedForward.forward()` |
| MoE | [moe.py](../moe.py)  , [](https://github.com/tirtza-weinfeld/broca/blob/main/moe.py)| `MoE.forward()`, `Experts.forward()` |
| Generation | [generation.py](../generation.py) , [](https://github.com/tirtza-weinfeld/broca/blob/main/generation.py) | `Llama4.generate()` |
| Config | [args.py](../args.py)  , [](https://github.com/tirtza-weinfeld/broca/blob/main/args.py)| `ModelArgs`, `MoEArgs` |
