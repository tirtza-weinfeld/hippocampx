...
export default async function Problem794ValidTicTacToeState() {
  return (
    <AgentCard
      id="794-valid-tic-tac-toe-state"
      ...
      leetcodeUrl="https://leetcode.com/problems/valid-tic-tac-toe-state/"
    >
