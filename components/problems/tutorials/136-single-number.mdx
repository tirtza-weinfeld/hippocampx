...
<PillList pills={["bit-manipulation", "xor"]} />

[136. Single Number](https://leetcode.com/problems/single-number)

## [!(ProblemDefinition)] Definition

Given a non-empty array of integers nums, every element appears twice except for one. Find that single one.    *[sky!]Achieve *linear* time complexity and *constant* space complexity.*
