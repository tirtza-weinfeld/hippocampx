    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          transition={{ duration: 0.2 }}
          className="bg-old-game-surface rounded-2xl p-8 max-w-sm w-full shadow-2xl text-center border border-old-game-border"
        ...
        >
          <div className="relative inline-block mb-5">
            ...
            >
              <Trophy className="h-16 w-16 text-old-game-primary" />
            </motion.div>
            <motion.div
            ...
            >
              <Sparkles className="h-5 w-5 text-old-game-primary" />
            </motion.div>
            <motion.div
          ...
          <h2 className="text-2xl font-bold text-old-game-primary mb-2">
            Congratulations!
          </h2>
          ...
          <button
            onClick={onClose}
            className="px-6 py-2.5 bg-old-game-gradient text-white font-medium rounded-full shadow-md hover:shadow-lg transition-shadow"
          >
            Play Again
          </button>
        </motion.div>
