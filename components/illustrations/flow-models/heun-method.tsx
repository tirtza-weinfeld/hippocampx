...
export const HeunMethodIllustration = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <motion.svg width="160" height="105" viewBox="0 0 160 105" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        ...
        <motion.g animate={{ opacity: phase !== "start" ? 0.4 : 1 }} transition={ease}>
        ...
        {/* Euler guess X' */}
        <motion.g animate={{ opacity: phase === "euler" || phase === "avg" || phase === "final" ? 1 : 0 }} transition={ease}>
        ...
        <motion.g animate={{ opacity: phase === "avg" || phase === "final" ? 1 : 0 }} transition={ease}>
        ...
        {/* Heun final position */}
        <motion.g animate={{ opacity: phase === "final" ? 1 : 0 }} transition={ease}>
