...
export const FlowMatchingLossIllustration = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <motion.svg width="160" height="105" viewBox="0 0 160 105" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        {/* Data point z */}
        <motion.g animate={{ opacity: phase !== "loss" ? 1 : 0.4 }} transition={ease}>
        ...
        {/* Interpolated x */}
        <motion.g animate={{ opacity: phase === "sample" ? 0 : 1 }} transition={ease}>
        ...
        {/* Neural network */}
        <motion.g animate={{ opacity: phase === "sample" || phase === "interpolate" ? 0.3 : 1 }} transition={ease}>
        ...
        {/* Predicted vector */}
        <motion.g animate={{ opacity: phase === "predict" || phase === "loss" ? 1 : 0 }} transition={ease}>
        ...
        {/* Target vector */}
        <motion.g animate={{ opacity: phase === "loss" ? 1 : 0 }} transition={ease}>
