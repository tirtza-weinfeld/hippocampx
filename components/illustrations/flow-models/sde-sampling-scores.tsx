...
export function SDESamplingScoresIllustration({ size = "md" }: { size?: IllustrationSize }) {
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <motion.svg className={sizeClasses[size]} viewBox="0 0 160 105" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        ...
        <motion.g initial={{ opacity: 0.3 }} animate={{ opacity: showScore || phase === "combined" ? 1 : 0.3 }} transition={ease}>
        ...
        <motion.g initial={{ opacity: 1 }} animate={{ opacity: showDrift ? 1 : 0.15 }} transition={ease}>
        ...
        {/* Score vector */}
        <motion.g initial={{ opacity: 0.15 }} animate={{ opacity: showScore ? 1 : 0.15 }} transition={ease}>
        ...
        {/* Noise vector (wiggly) */}
        <motion.g initial={{ opacity: 0.15 }} animate={{ opacity: showNoise ? 1 : 0.15 }} transition={ease}>
        ...
        {/* Combined result */}
        <motion.g initial={{ opacity: 0 }} animate={{ opacity: phase === "combined" ? 1 : 0 }} transition={ease}>
