...
export const ConditionalMarginalIllustration = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <motion.svg width="160" height="105" viewBox="0 0 160 105" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        ...
        <motion.g animate={{ opacity: showCond(1) }} transition={ease}>
        ...
        <motion.g animate={{ opacity: showCond(2) }} transition={ease}>
        ...
        <motion.g animate={{ opacity: showCond(3) }} transition={ease}>
        ...
        {/* Conditional vectors */}
        <motion.line x1={origin.x} y1={origin.y} x2={vec1.x} y2={vec1.y} className="stroke-red-500 dark:stroke-red-400" strokeWidth="2" markerEnd="url(#cm-v1)" animate={{ opacity: showCond(1) }} transition={ease} />
        <motion.line x1={origin.x} y1={origin.y} x2={vec2.x} y2={vec2.y} className="stroke-violet-500 dark:stroke-violet-400" strokeWidth="2" markerEnd="url(#cm-v2)" animate={{ opacity: showCond(2) }} transition={ease} />
        <motion.line x1={origin.x} y1={origin.y} x2={vec3.x} y2={vec3.y} className="stroke-sky-500 dark:stroke-sky-400" strokeWidth="2" markerEnd="url(#cm-v3)" animate={{ opacity: showCond(3) }} transition={ease} />

        {/* Marginal vector */}
        <motion.line x1={origin.x} y1={origin.y} x2={marginal.x} y2={marginal.y} className="stroke-green-500 dark:stroke-green-400" strokeWidth="2.5" markerEnd="url(#cm-marg)" animate={{ opacity: phase === "marginal" ? 1 : 0 }} transition={ease} />

        {/* Formula */}
        <motion.g animate={{ opacity: phase === "marginal" ? 1 : 0 }} transition={ease}>
