...
// Inorder: go left → visit → go right
const steps: Step[] = [
  { label: "Start inorder traversal", stack: [], output: [] },
  { label: "Push 4, go left", current: 0, stack: [0], output: [], phase: "descend" },
  { label: "Push 2, go left", current: 1, stack: [0, 1], output: [], phase: "descend" },
  { label: "Push 1, go left (null)", current: 3, stack: [0, 1, 3], output: [], phase: "descend" },
  { label: "Visit 1, output [1]", current: 3, stack: [0, 1], output: [1], phase: "visit" },
  { label: "Back to 2, visit", current: 1, stack: [0], output: [1, 2], phase: "visit" },
  { label: "Go right to 3", current: 4, stack: [0, 4], output: [1, 2], phase: "descend" },
  { label: "Visit 3, output [1,2,3]", current: 4, stack: [0], output: [1, 2, 3], phase: "visit" },
  { label: "Back to 4, visit root", current: 0, stack: [], output: [1, 2, 3, 4], phase: "visit" },
  { label: "Go right to 6", current: 2, stack: [2], output: [1, 2, 3, 4], phase: "descend" },
  { label: "Push 6, go left to 5", current: 5, stack: [2, 5], output: [1, 2, 3, 4], phase: "descend" },
  { label: "Visit 5", current: 5, stack: [2], output: [1, 2, 3, 4, 5], phase: "visit" },
  { label: "Back to 6, visit", current: 2, stack: [], output: [1, 2, 3, 4, 5, 6], phase: "visit" },
  { label: "Go right to 7", current: 6, stack: [6], output: [1, 2, 3, 4, 5, 6], phase: "descend" },
  { label: "Visit 7", current: 6, stack: [], output: [1, 2, 3, 4, 5, 6, 7], phase: "visit" },
  { label: "Complete! Left → Root → Right", stack: [], output: [1, 2, 3, 4, 5, 6, 7] },
]

const ease = { type: "spring", stiffness: 120, damping: 20 } as const

export function InorderTraversalIllustration({
  size = "md",
