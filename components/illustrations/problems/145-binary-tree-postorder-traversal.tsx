...
type Step = {
  ...
  stack: number[]
  output: number[]
  phase?: "descend" | "visit" | "ascend"
}

// Postorder: go left → go right → visit
const steps: Step[] = [
  { label: "Start postorder traversal", stack: [], output: [] },
  { label: "Push 4, go left", current: 0, stack: [0], output: [], phase: "descend" },
  { label: "Push 2, go left", current: 1, stack: [0, 1], output: [], phase: "descend" },
  { label: "Push 1 (leaf)", current: 3, stack: [0, 1, 3], output: [], phase: "descend" },
  { label: "Visit 1 (no children)", current: 3, stack: [0, 1], output: [1], phase: "visit" },
  { label: "Back to 2, go right to 3", current: 4, stack: [0, 1, 4], output: [1], phase: "descend" },
  { label: "Visit 3 (no children)", current: 4, stack: [0, 1], output: [1, 3], phase: "visit" },
  { label: "Visit 2 (both done)", current: 1, stack: [0], output: [1, 3, 2], phase: "visit" },
  { label: "Back to 4, go right to 6", current: 2, stack: [0, 2], output: [1, 3, 2], phase: "descend" },
  { label: "Push 6, go left to 5", current: 5, stack: [0, 2, 5], output: [1, 3, 2], phase: "descend" },
  { label: "Visit 5 (no children)", current: 5, stack: [0, 2], output: [1, 3, 2, 5], phase: "visit" },
  { label: "Back to 6, go right to 7", current: 6, stack: [0, 2, 6], output: [1, 3, 2, 5], phase: "descend" },
  { label: "Visit 7 (no children)", current: 6, stack: [0, 2], output: [1, 3, 2, 5, 7], phase: "visit" },
  { label: "Visit 6 (both done)", current: 2, stack: [0], output: [1, 3, 2, 5, 7, 6], phase: "visit" },
  { label: "Visit 4 (root last!)", current: 0, stack: [], output: [1, 3, 2, 5, 7, 6, 4], phase: "visit" },
  { label: "Complete! Left → Right → Root", stack: [], output: [1, 3, 2, 5, 7, 6, 4] },
]

const ease = { type: "spring", stiffness: 120, damping: 20 } as const

export function PostorderTraversalIllustration({
  size = "md",
