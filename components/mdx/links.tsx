    ...
    >
      <motion.span className={cn("relative text-link-gradient")}>
        ...
        <span className="whitespace-nowrap">
          {isExternal ? (
            <span className="link-marker group-hover:-translate-y-1 transition-transform duration-300
              text-teal-600 group-hover:text-teal-700 dark:text-teal-700 dark:group-hover:text-teal-400 ml-1 inline-block">
              <ExternalLink className="w-4 h-4" />
            </span>
          ) : (
            <span className={cn("link-marker group-hover:-translate-y-1 transition-transform duration-300 ml-1 inline-block",
